...
public class HealthActivity extends Activity {
	...
	public void updateInfo() {
		...
		if (ret.getRet_code() == 0) {
			HealthStat healthStat = HealthStat.jiexi_by_str(ret.getOrg_str());
			if (healthStat != null) {
			...
			Toast.makeText(HealthActivity.this, "获取健康信息失败：  " + ret.getMsg(),
		...
		if (ret.getRet_code() == 0) {
			HeartRateList heartList = HeartRateList.parse(ret.getOrg_str());
