...
public class UserOrderActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		new_order_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//新建一个页面；todo
				Intent intent_yuyue = new Intent(UserOrderActivity.this,DoctorOrderActivity.class);
	...
	private void paser_user_order_list() {
		// TODO Auto-generated method stub
		ReturnObj ret_obj =  MainActivity.client_in_strict_mode.get_user_order_list(MainActivity.myUser.getId());
	...
	private void jieXi(String str) {
		...
		try {
			...
			for(int i = 0; i < length; i++) {
				...
				order_tmp.setStatus(Integer.parseInt(oj_tmp.getString("status")));
